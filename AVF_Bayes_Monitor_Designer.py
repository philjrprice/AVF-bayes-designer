...
if s_min_sel is None: 
 ...
 bars_y = [res_p1_qgood.get('eff_early_succ_rate', 0.0), res_p1_qgood.get('fut_early_rate', res_p1_qgood.get('eff_early_fut_rate', 0.0))] 
 if enable_safety: 
 ...
 early_fut = res_p1_qgood.get('fut_early_rate', res_p1_qgood.get('eff_early_fut_rate', 0.0)) 
 ...
 fut_by_look = res_p1_qgood.get('fut_early_by_look', res_p1_qgood.get('early_fut_by_look_eff', [])) 
