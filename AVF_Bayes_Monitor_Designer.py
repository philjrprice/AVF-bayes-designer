...
with main_tabs[0]:
    ...
    run_btn = st.button("Run Quick Scan", type="primary", key="run_quick_scan_btn")
...
with main_tabs[1]:
    ...
    cmp_btn = st.button("Run Comparison", key="run_comparison_btn")
...
with main_tabs[2]:
    ...
    deep_btn = st.button("Run Deep Dive", key="run_deepdive_btn")
...
with main_tabs[3]:
    ...
    run_oc_btn = st.button("Run OC Matrix", key="run_oc_btn")
...
with main_tabs[4]:
    ...
    if st.button("Build export zip", key="build_export_zip_btn"):
        try:
